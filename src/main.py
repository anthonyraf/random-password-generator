...
class Window(Tk):
    ...
    def __init__(self):
        ...
        self.form_title = Label(self,
                                text="Choose the options you want:",
        ...
        self.length_input_widget = Entry(self,
                                         width=50,
                                         validate="key",
                                         validatecommand=vcmd)
        self.length_input_widget.place(x=100, y=120)

        self.letters_l = Switch(self,
                                text="Lowercase letters",
                                font=("Segoe UI", 13, ""))
        self.letters_l.place(x=40, y=160)

        self.letters_u = Switch(self,
    ...
    def generate_password(self) -> str:
        ...
        if self.length_input_widget.get() == "" or not any([
                self.letters_l.get(),
                self.letters_u.get(),
                self.digits.get(),
                self.symbols.get(),
            ...
            password = gen(
                length=int(self.length_input_widget.get()),
    ...
    def save_to_file(self):
        file = customtkinter.filedialog.asksaveasfile(mode="w",
