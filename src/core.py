...
from string import (ascii_lowercase, ascii_uppercase, digits as digits_, punctuation as symbols_) # import string constants

class Generator:
    def __init__(self, length=32, letters_l=True, letters_u=True, digits=True, symbols=True):
        self.entry = ""
        self.length = length
        if letters_l:
